...
<flux:text class="mt-1">{{ __('Enerģētikas iela 2-5, Mālpils, Siguldas novads, Latvija, LV-2152') }}</flux:text>
<flux:text class="mt-1">{{ __('Reg. number:') }} 40203531461</flux:text>
