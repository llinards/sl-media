...
<meta name="description" content="{{ $description ?? config('app.description', 'S&L Media SIA') }}" />
...
<meta property="og:description" content="{{ $description ?? config('app.description', 'S&L Media SIA') }}" />
...
<meta property="twitter:description" content="{{ $description ?? config('app.description', 'S&L Media SIA') }}" />
